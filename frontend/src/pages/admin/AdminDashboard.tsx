      ...
      <aside className="hidden lg:flex w-72 bg-white border-r border-slate-200 flex-col sticky top-0 h-screen z-50 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        <div className="p-8 flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-black text-blue-600 tracking-[0.3em] mt-1">
              DIGIDESA
            </span>
          </div>
        </div>
        ...
        <div className="p-8">
          <div className="p-5 bg-slate-50 rounded-[2rem] border border-slate-100 flex flex-col items-center text-center">
            ...
            <p className="text-slate-900 text-[11px] font-black uppercase">
              Sistem Terenkripsi
            </p>
        ...
        <header className="h-24 bg-white/80 backdrop-blur-md border-b border-slate-100 sticky top-0 z-40 px-10 flex items-center justify-between">
          <div className="flex flex-col">
            <h1 className="text-lg font-black text-slate-900 tracking-tight">
              Panel Eksekutif Desa
            </h1>
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">
              Wilayah Cisaladah • Rabu, 29 April 2026
            </p>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 pl-6 border-l border-slate-100">
              ...
              <img
                className="w-12 h-12 rounded-2xl shadow-inner border-2 border-white ring-1 ring-slate-100"
            ...
            {SUMMARY_STATS.map((s, i) => (
              ...
              >
                <div className="flex justify-between items-start">
                  <div
                    className={`w-14 h-14 rounded-2xl bg-${s.color}-50 flex items-center justify-center transition-colors group-hover:bg-${s.color}-600`}
                  >
                    <s.icon
                      className={`text-${s.color}-600 group-hover:text-white transition-colors`}
                      size={24}
                      strokeWidth={2.5}
                    />
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            >
              ...
              <div className="p-8 bg-slate-50/50 text-center border-t border-slate-50">
                <button className="text-[11px] font-black text-blue-600 hover:underline uppercase tracking-[0.2em]">
                  Lihat Seluruh Arsip Digital
                </button>
              </div>
            </motion.div>
              ...
              <div className="bg-white rounded-[3rem] p-10 border border-red-100 shadow-sm relative overflow-hidden">
                ...
                <div className="space-y-6 relative z-10">
                  <div className="p-6 bg-slate-50 rounded-[2rem] border border-slate-100 hover:bg-white hover:border-blue-200 transition-all cursor-pointer">
                    <span className="text-[9px] font-black text-red-600 bg-red-50 px-2 py-0.5 rounded-md uppercase">
                      High Priority
                    </span>
                    <h4 className="text-sm font-black text-slate-900 mt-3 tracking-tight">
                      Jembatan Blok D Retak
                    </h4>
                    <p className="text-[11px] text-slate-500 mt-2 font-medium leading-relaxed">
                      Dilaporkan oleh RT 02 Cisaladah. Segera kirim tim teknis.
                    </p>
                  </div>
                </div>
