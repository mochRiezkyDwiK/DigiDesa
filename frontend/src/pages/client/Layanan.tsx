...
import LayoutWarga from "./layoutWarga"; // Pastikan path import ini sesuai lokasi LayoutWarga Anda
...
export default function Layanan() {
  ...
  return (
    <LayoutWarga user={user ? { nama_lengkap: user.nama, rt: user.rt, rw: user.rw } : null}>
      <div className="bg-[#FDFEFF] font-sans antialiased pb-20">
