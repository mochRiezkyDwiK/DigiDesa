        ...
        {step === 1 ? (
          ...
          >
            ...
            <div className="lg:col-span-1 space-y-6">
              <motion.div
                ...
                variants={FADE_UP}
                custom={0}
                className="bg-slate-900 p-8 rounded-[2rem] text-white shadow-xl relative overflow-hidden"
              >
                ...
                <p className="text-slate-400 text-xs leading-relaxed mb-6">
                  Sistem DigiDesa mendeteksi profil Anda. Kolom yang sudah
                  terekam di database kelurahan akan otomatis terkunci demi
                  integritas data, sedangkan kolom yang masih kosong terbuka
                  untuk Anda lengkapi.
                </p>
              ...
              <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        required
                        className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 px-5 text-sm font-bold outline-none text-slate-800"
                      >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        disabled={!!dbUser?.jenis_kelamin}
                        className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 px-5 text-sm font-bold outline-none text-slate-800 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed"
                      >
                ...
                <section className="space-y-5 pt-4 border-t border-gray-50">
                  ...
                  <div className="space-y-2 pt-2">
                    <label className="text-[11px] font-black uppercase tracking-wider text-blue-600 ml-1">
                      Alasan Pengajuan Surat (Wajib Diisi) *
                    </label>
                    <textarea
                      name="keperluan"
                      rows={4}
                      ...
                      onChange={handleChange}
                      required
                      placeholder="Contoh: Syarat kelengkapan berkas administrasi pembukaan rekening Bank Mandiri..."
                      className="w-full bg-blue-50/20 border border-blue-100 rounded-2xl py-4 px-5 text-sm font-bold focus:ring-4 focus:ring-blue-500/5 focus:bg-white outline-none transition-all resize-none text-slate-900"
                    />
                  </div>
                </section>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-5 bg-blue-600 text-white font-black text-xs uppercase tracking-[0.2em] rounded-2xl hover:bg-blue-700 shadow-xl shadow-blue-500/20 transition-all flex items-center justify-center gap-3 disabled:bg-blue-400"
                >
                  {loading ? (
                    "Memproses Data..."
                  ) : (
                    <>
                      <Send size={18} /> Kirim Permohonan Resmi
                    </>
                  )}
                </button>
              </div>
          ...
          >
            ...
            <p className="text-gray-500 font-medium mb-10 leading-relaxed">
              Permohonan Anda sudah berhasil tersimpan di sistem desa.
            </p>
            <div className="space-y-4">
              <button
                type="button"
                onClick={() => navigate("/dashboard-warga")}
                className="w-full py-4 bg-gray-900 text-white font-black text-xs uppercase tracking-widest rounded-2xl hover:bg-black transition-all"
              >
                Lihat Status Surat
              </button>
            </div>
