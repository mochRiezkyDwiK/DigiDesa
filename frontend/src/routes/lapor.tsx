...
export default function LaporPage() {
  ...
  return (
    // ✅ Membungkus halaman menggunakan LayoutWarga
    <LayoutWarga>
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        {/* MAIN CONTENT AREA */}
        <main className="relative max-w-7xl mx-auto px-6 py-5 z-10 w-full">
          ...
          <div className="fixed top-0 left-0 w-screen h-screen z-[999] flex items-center justify-center px-4">
            ...
            >
              ...
              <div className="mt-7 flex flex-col gap-2.5">
                ...
                <button
                  onClick={() => navigate({ to: "/" })} // 🔄 PERBAIKAN: Gunakan objek { to: path } untuk TanStack Router
